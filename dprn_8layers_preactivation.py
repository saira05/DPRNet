...
class PointConvNet:
    ...
    def model(self, points_tensor, input_tensor, is_training=True):
        ...
        feat = tf.concat([relu1, relu2, relu3, relu4, relu5, relu6, relu7, relu8], axis=2) #local features
